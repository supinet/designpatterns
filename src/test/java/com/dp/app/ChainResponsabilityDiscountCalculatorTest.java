...
import com.dp.app.chainresponsability.discount.DiscountCalculator;

public class ChainResponsabilityDiscountCalculatorTest {
    ...
    public void testCalculate() {
        ...
        assertEquals(qtd, new BigDecimal("10.00"));
    }
